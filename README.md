...
Electrolite is a design-stage project for syncing named SQLite table
shapes to browsers without a separate sync daemon. The intended shape:
...
Idea scaffold. APIs and implementation language are not settled.
